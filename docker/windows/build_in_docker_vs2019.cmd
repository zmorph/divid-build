...
cmake -DCMAKE_BUILD_TYPE=Release ^
      ...
      -DBUILD_OS_WIN64=ON ^
      -DSIGN_PACKAGE=ON ^
      -DWINDOWS_IDENTITIY_PFX_FILE="%WINDOWS_IDENTITIY_PFX_FILE%" ^
      ...
      -DCURAENGINE_ENABLE_MORE_COMPILER_OPTIMIZATION_FLAGS="OFF" ^
...
copy /y "Zmorph_Divid*.exe" %CURA_BUILD_OUTPUT_PATH%\output
copy /y "Zmorph_Divid*.msi" %CURA_BUILD_OUTPUT_PATH%\output
