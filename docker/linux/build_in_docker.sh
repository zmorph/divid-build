...
export FDMMATERIALS_BRANCH_OR_TAG="${FDMMATERIALS_BRANCH_OR_TAG:-master}"
...
chmod a+x Zmorph_Divid-*.AppImage
cp Zmorph_Divid-*.AppImage "${CURA_BUILD_OUTPUT_DIR}/appimages"
